  ...
  */
  ...
  drawH = ih * scaleBase * scale;
    ...
    /* ---------------------------
        ...
        --------------------------- */
      marginTopPx = (parseFloat(marginTop.value || 5) / 10) * PX_PER_CM;
      marginBottomPx = (parseFloat(marginBottom.value || 5) / 10) * PX_PER_CM;
      marginLeftPx = (parseFloat(marginLeft.value || 5) / 10) * PX_PER_CM;
      marginRightPx = (parseFloat(marginRight.value || 5) / 10) * PX_PER_CM;  
